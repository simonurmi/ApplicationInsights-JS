...
export class DynamicTests extends AITestClass {
    ...
    public registerTests() {
        ...
        this.testCase({
            name: "ApplicationInsightsCore: Initialization and unload with Channel",
            test: () => {
        ...
        this.testCase({
            name: "ApplicationInsightsCore: Initialization and unload with plugins",
            test: () => {
        ...
        this.testCase({
            name: "ApplicationInsightsCore: Initialization with plugins and unload trackPlugin",
            test: () => {
        ...
        this.testCase({
            name: "ApplicationInsightsCore: Initialization with plugins and unload and reload samplingPlugin",
            test: () => {
        ...
        this.testCase({
            name: "ApplicationInsightsCore: Initialization with plugins and unload shared trackPlugin only",
            test: () => {
        ...
        this.testCase({
            name: "ApplicationInsightsCore: Initialization with plugins and unload core but not trackPlugin",
            test: () => {
        ...
        this.testCase({
            name: "ApplicationInsightsCore: Initialization with plugins and unload shared old trackPlugin only",
            test: () => {
        ...
        this.testCase({
            name: "ApplicationInsightsCore: Initialization with plugins and unload core but not old trackPlugin",
            test: () => {
